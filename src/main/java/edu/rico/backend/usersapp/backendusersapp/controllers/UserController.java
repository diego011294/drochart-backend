...
public class UserController {
    ...
    public ResponseEntity<?> getUserWithMostPosts(){
        Optional<User> user = service.findUserWithMostPosts();
        if (user.isPresent()) {
    ...
    Optional<UserDto> userDtoOptional = service.getUserByUsername(username);
